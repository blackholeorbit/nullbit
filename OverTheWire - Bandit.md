...
**Site**: [OverTheWire](https://overthewire.org/wargames/bandit/)
...
```
Once I established a ssh connection, I used the password mentioned in the Bandit Level 0 description to log in. The
following banner appeared:
